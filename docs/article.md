...
![Picture](images/map_shuffle.png)
...
![Picture](images/map_billiard.png)
...
<img src="images/byi.svg" alt="$$B_{y}(i) = \left\lfloor \dfrac{i \cdot y}{2^{\text{pow}}} \right\rfloor \bmod 2$$">
...
- $\text{BinaryFloor}_{y}(x) = \left( \left\lfloor \dfrac{x \cdot y}{2^p} \right\rfloor \bmod 2 \right)$

Then:

<img src="images/equi.svg" alt="$\boxed{\text{Shuffle}_{y}^{[2p+1]}(x) = 1 - \text{BinaryFloor}_{y}(N - x - 1)}$">
...
[Static Visualization](https://xcont.com/billiard_dynamic/hologram_static/)  
[`hologram_s.js`](https://github.com/xcontcom/billiard-fractals/blob/main/js/hologram_s.js)

[Dynamic Visualization](https://xcont.com/billiard_dynamic/hologram_dynamic/hologram_dynamic.html)  
[`hologram_dynamic.js`](https://github.com/xcontcom/billiard-fractals/blob/main/js/hologram_dynamic.js)

[Hologram Experiment](https://xcont.com/billiard_dynamic/hologram_dynamic/hologram_reconstruction.html)  
[`hologram_reconstruction.html`](https://github.com/xcontcom/billiard-fractals/blob/main/js/hologram_reconstruction.html)
